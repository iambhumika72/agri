...
export default function SystemHealthPage() {
  ...
  const getStatusColor = (status) => {
    return status === 'ok' || status === 'online' ? 'bg-emerald-500' : 'bg-red-500';
  };
    ...
    <div className="max-w-7xl mx-auto space-y-6 pb-24 md:pb-8">
      <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4">
        <PageHeader 
          ...
          descKey="Live status of AgriSense backend services." 
          icon={Activity} 
        />
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
            ...
            <div className="card flex items-start gap-4">
              ...
              <div className="flex-1">
                ...
                <p className="text-xs text-neutral-500 mb-2">Version {health.version} ({health.environment})</p>
            ...
            <div className="card flex items-start gap-4">
              ...
              <div className="flex-1">
                <div className="flex items-center justify-between mb-1">
                  <h3 className="font-bold text-neutral-800">Historical DB</h3>
                  <span className={`rounded-full h-3 w-3 ${getStatusColor(health.components?.db || 'ok')}`}></span>
                </div>
                <p className="text-xs text-neutral-500 mb-2">Vector & Relational</p>
                <div className="text-sm">
                  <p>Status: {health.components?.db || 'Operational'}</p>
                </div>
              </div>
            </div>
